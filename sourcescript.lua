...
v0.new("<Color=Cyan>Welcome to trannamkhanh Hub<Color=/>"):Display();
wait(0.5);
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "trannamkhanh Hub",
	Text = "Loading...",
	Icon = "rbxthumb://type=&id=83190276951914&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
